...
if (!defined('RUNCLOUD_HUB_VERSION')) {
    define('RUNCLOUD_HUB_VERSION', '1.4.9');
}
if (!defined('RUNCLOUD_HUB_VERSION_PREV')) {
    define('RUNCLOUD_HUB_VERSION_PREV', '1.4.8');
}
...
final class RunCloud_Hub
{
    ...
    public static function plugins_api_filter($res, $action, $args) {
        if (self::$slug !== $args->slug) {
            // should return $res on non runcloud-hub plugin as they also may rely on the same plugins_api filter
            return $res;
        }
